...
const LeftBar = () => {
  ...
  return (
    <aside
      className={`bg-primarytwo  text-black dark:text-white border-r fixed left-0 top-0 bottom-0 flex flex-col z-50 w-dvw sm:w-2xs transform transition-all duration-300 ease-in-out
        ${
          isSidebarOpen
    ...
    >
      <div className="border-b shrink-0 p-3 flex gap-2 items-center">
        <LanguageDropdown />
        <button
